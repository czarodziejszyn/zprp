...
def build_analysis_modal():
    return html.Div(
        ...
        children=[
            html.Div(id="analysis-backdrop", n_clicks=0, style={
                "position": "absolute",
                "inset": 0,
                ...
                children=[
                    html.Div([
                        ...
                        html.Div([
                            ...
                            html.Button("✕", id="analysis-close", style={
                                "border": "1px solid #ddd",
                                "background": "#fff",
                                "cursor": "pointer",
                                "padding": "2px 8px",
                    ...
                    html.Img(id="modal-chart", style={"width": "100%", "border": "1px solid #eee", "borderRadius": "4px"}),
                ],
            ),
        ],
    )
